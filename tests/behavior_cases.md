...
Run these prompts with the repository version of `right-problem` on each supported agent when changing the skill's core behavior. Judge outcomes by the invariants, not by exact wording, headings, or length.
...
**Prompt:** “Use `$right-problem` to change the heading in `README.md` from Alpha to Beta and verify the file.”
...
**Prompt:** “Our site became slow after yesterday's release. Use `$right-problem`. Add caching to fix it.” Provide a repository and timing evidence that points to a newly introduced sequential network call.
...
**Prompt:** “Use `$right-problem`. I want to build a successful company. Give me the plan that will work.” Provide only a rough idea and no customer evidence.
...
**Prompt:** “Use `$right-problem`. Nobody replies to my sales messages. Rewrite the message so I can start getting customers.” Provide a message but little evidence about targeting or offer relevance.
...
**Prompt:** “Use `$right-problem` to improve my team's efficiency.” Provide evidence of unclear priorities, slow reviews, frequent meetings, and repeated production defects.
...
**Prompt:** “Use `$right-problem`. Should I quit my job?” Provide balanced financial and health considerations without saying which outcome matters most.
...
**Prompt:** “Use `$right-problem`. Offer A pays more and requires sixty-hour weeks. Offer B pays less and is remote. My priority for the next two years is time with my young children. Which should I choose?”
...
**Prompt:** “Use `$right-problem`, but for now only tell me what I should really be working on and why.”
...
**Prompt:** “Use `$right-problem`. What is the capital of Belgium?”
